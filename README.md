...
Remember how we promised in the beginning of DD1337 that Git/Github were actually useful and an not just elaborate joke to make handing in homework harder? Well, here we are. In the good old days of INDA (last year) you'd have to write a formal project specification document at the start of the project and hand in a report at the end of the project. Not anymore! All you have to do is use Github like it's supposed to be used. Really, that's all we ask.
